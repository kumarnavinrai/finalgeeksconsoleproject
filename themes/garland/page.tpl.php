          ...
          <div id="custtable">
            ...
            <?php   foreach($arrayofparents as $item) { ?>
              <tr>
                ...
                <td><?php echo $item['user_name']; ?> <?php echo isset($noofmsgarray[$item['instance_id']])?"(".$noofmsgarray[$item['instance_id']].")":""; ?></td>
                ...
                <td><?php echo $item['child']['user_name']; ?><?php echo isset($noofmsgarray[$item['child']['instance_id']])?"(".$noofmsgarray[$item['child']['instance_id']].")":""; ?></td>
  ...
  $(document).ready(function(){
      ...
      jQuery("#edit-submit").on('click',function(e){
          ...
          selectedcheckboxes = jQuery("input[name=clientports]:checked").map(function() { 
            ...
            var abc = this.value;
            var valtosend = this.value + "#" + $(this).attr('data');
            if(abc.indexOf("i") != -1){
                return 000;
            }
              return valtosend;
          ...
          selectedcheckboxeschild = jQuery("input[name=clientportschild]:checked").map(function() { console.log($(this).attr('data'));
      ...
      jQuery(".todayinstall").html("<?php echo isset($totalinstall)?$totalinstall:0; ?>");
