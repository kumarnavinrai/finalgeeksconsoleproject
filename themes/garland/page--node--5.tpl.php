              ...
              function drawChart() {
                var data = google.visualization.arrayToDataTable([
                  ...
                  <?php foreach($arr as $key => $val){  ?>  
                    ['<?php echo $key; ?>', <?php $p = current($val);  echo isset($p[1])?$p[1]:0; ?>, <?php $p = next($val); print_r($p); echo isset($p[2])?$p[2]:0; ?>, <?php $p = next($val); echo isset($p[3])?$p[3]:0; ?>, <?php $p = next($val); echo isset($p[4])?$p[4]:0; ?>, <?php $p = next($val); echo isset($p[5])?$p[5]:0; ?>, <?php $p = next($val); echo isset($p[6])?$p[6]:0; ?>, <?php $p = next($val); echo isset($p[7])?$p[7]:0; ?>, <?php $p = next($val); echo isset($p[8])?$p[8]:0; ?>],
                  <?php } ?>  
                  <?php } ?>
