              ...
              function drawChart() {
                var data = google.visualization.arrayToDataTable([
                  ...
                  <?php foreach($arr as $key => $val){  ?>  
                    ['<?php echo $key; ?>', <?php if(in_array(0, $adminselectforgraphsecondstring[$host])){ ?><?php $p = $val; echo isset($p[0])?$p[0]:0; ?>,<?php } ?> <?php if(in_array(1, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[1])?$p[1]:0; ?>,<?php } ?> <?php if(in_array(2, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[2])?$p[2]:0; ?>,<?php } ?> <?php if(in_array(3, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[3])?$p[3]:0; ?>,<?php } ?> <?php if(in_array(4, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[4])?$p[4]:0; ?>,<?php } ?> <?php if(in_array(5, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[5])?$p[5]:0; ?>,<?php } ?> <?php if(in_array(6, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[6])?$p[6]:0; ?>,<?php } ?> <?php if(in_array(7, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[7])?$p[7]:0; ?>,<?php } ?> <?php if(in_array(8, $adminselectforgraphsecondstring[$host])){ ?><?php echo isset($p[8])?$p[8]:0; ?><?php } ?>],
                  <?php } ?>  
                  <?php } ?>
